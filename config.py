...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "ʀᴀꜱᴀᴛʜɪ ʙᴀᴇ ᴍᴜsɪᴄ")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Cutey02/Cmx")
...
PLAYLIST_IMG_URL = "https://graph.org/file/35c464bd07d8613092611.jpg"
...
STREAM_IMG_URL = "https://graph.org/file/35c464bd07d8613092611.jpg"
...
if PING_IMG_URL:
    if PING_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://te.legra.ph/file/da6c7c88a35c41ec6b579.jpg"

if START_IMG_URL:
    if START_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://te.legra.ph/file/da6c7c88a35c41ec6b579.jpg"
